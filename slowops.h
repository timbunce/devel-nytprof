...
/* PL_ppaddr[OP_REQUIRE] = pp_slowop_profiler; XXX some corruption somewhere */
...
/*PL_ppaddr[OP_SUBSTCONT] = pp_slowop_profiler; XXX needs special handling like OP_GOTO */
